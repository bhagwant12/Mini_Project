...
from datails import DetailsRoom
class HotelManagementSystem:
    def __init__(self,root):
        ...
        img1=Image.open(r"F:\project\redd.jpg")
        ...
        lbl_title=Label(self.root,text="REDISSON BLU HOTEL", font=("times new roman",40,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        ...
        img3=Image.open(r"F:\project\rec.jpg")
        ...
        img4=Image.open(r"F:\project\room.jpg")
        ...
        img5=Image.open(r"F:\project\food.jpg")
